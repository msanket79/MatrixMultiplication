//In this we changed the n and k loop to maximize the cache hits
//In the previous method we were getting good temporal locality  for A and C but very Bad for C
//So we interchanged the k and n loop so that the B and C get good temporal locality and A gets excellent temporal locality
